...
| SEC-01 | 1 | Tainted log sites (webhook_manager ×2, controller:790, controller:760, controller:975) route through helper | unit | `pytest tests/unittests/test_controller/test_webhook_manager.py tests/unittests/test_controller/ -x` | ⚠️ partial |
